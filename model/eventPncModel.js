...
// function getEventsPncFromDB(seasonID, callback) {
//   if(seasonID == 999) {
//     var queryDB = "SELECT p.eventID, p.metCommissionBonus, p.guarantee, p.totalSales, p.alcSales, p.coordinatorAdminAmt, p.eventCountsTowardsTotal " +
//                   "FROM event e, event_pnc p " +
//                    "AND e.idevent = p.eventID";
//   }
//   else {
//     var queryDB = "SELECT p.eventID, p.metCommissionBonus, p.guarantee, p.totalSales, p.alcSales, p.coordinatorAdminAmt, p.eventCountsTowardsTotal " +
//                   "FROM event e, event_pnc p " +
